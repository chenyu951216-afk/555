...
MINIMUM_RECORD_START_AT = datetime.fromisoformat("2026-05-08T00:00:00+08:00")
...
class Settings(BaseSettings):
    ...
    backend_cors_origin_regex: str | None = Field(default=r"https://.*\.zeabur\.app", alias="BACKEND_CORS_ORIGIN_REGEX")
    ...
    bitget_sync_lookback_days: int = Field(default=90, alias="BITGET_SYNC_LOOKBACK_DAYS")
